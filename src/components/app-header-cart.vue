<template>
  <div class="cart">
    <RouterLink class="curr" href="javascript:;" to="/cart">
...
export default {
  ...
  setup(){
    ...
    store.dispatch('cart/findCartList').then(()=>{Message({type:'success',text:'更新本地成功'})})
      // 删除
...
.cart {
  ...
  .layer {
    ...
    transform: translateY(-200px) scale(1, 0);//高度缩放成0
    width: 400px;
    height: 400px;
    position: absolute;
    top: 50px;
