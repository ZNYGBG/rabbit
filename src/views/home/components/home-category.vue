<!--
 * @Author: your name
 * @Date: 2021-12-07 23:32:11
 * @LastEditTime: 2021-12-12 17:35:42
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \项目完整源码\rabbit\eribbit\src\views\home\components\home-category.vue
-->
<template>
  ...
  <li class="brand" v-for="item in currentCategory.brands" :key="item">
    <RouterLink to="/">
      <img :src="item.picture" alt="">
      <div class="info">
...
// 骨架动画
.xtx-skeleton {
  animation: fade 1s linear infinite alternate;//alternate 135向前，246向后.
}
@keyframes fade {
  from {
    opacity: 0.2;
